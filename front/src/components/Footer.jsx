    ...
    <footer className="bg-[#04091e]">
      <div className="container">
        <div className="flex flex-col py-[145px]">
          <div className="flex justify-between text-[#777777] border-b-[1px] border-slate-700 pb-[40px]">
            <div className="flex gap-4">
              ...
              <div className="flex flex-col gap-5">
                ...
                <div className="flex gap-[40px] text-[14px] font-light">
            ...
            <div className="flex gap-4">
              <div className="flex flex-col gap-5 w-[270px]">
                ...
                <form action="" className="flex">
                  <input
                    className="bg-inherit border border-slate-600 text-[13px] px-[20px] py-2"
          ...
          <div className="flex justify-between text-[#777777] mt-[40px] items-center">
            <span className="text-[14px] font-light">Copyright ©2023 All rights reserved</span>
