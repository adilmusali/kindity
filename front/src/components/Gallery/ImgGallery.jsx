      ...
      >
        <div className="container">
          <div className="flex flex-col gap-5 text-white text-center py-[100px]">
            <h2 className="text-[48px] font-bold">Image Gallery</h2>
            <div className="flex gap-2 text-[14px] font-light mx-auto"><Link to={"/"} className="flex items-center gap-2 
            text-white hover:text-[#ea2c58] transition duration-500">Home<BsArrowRight/></Link><a href="/gallery"
