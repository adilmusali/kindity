  ...
  return (
    <section className='bg-[#f9f9ff]'>
        <div className="container">
            <div className='flex gap-[80px] py-[120px] items-center'>
                <div className='w-[28%] flex flex-col gap-5'>
                    <h2 className='text-[36px] font-semibold'>Testimonial from our Donors</h2>
                ...
                <div className='flex justify-between gap-[50px] w-[70%]'>
                    {data.map((d) => {
                        return(
                            <div key={d._id} className='flex flex-col gap-[30px] text-center bg-white p-[40px]'>
